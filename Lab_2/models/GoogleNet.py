...
class Inception(nn.Module):
    def __init__(self, c1: int, c2: int, c3: int, c4: int, **kwargs):
...
class GoogleNet(nn.Module):
    def __init__(self, num_classes: int):
        ...
        self.inception_3 = nn.Sequential( # inception_3 includes two Inception modules (3a and 3b) as defined in the original GoogleNet paper.
            Inception(64, (96,128), (16, 32), 32), # Shape(B, 64 + 128 + 32 + 32 = 256, H, W)
            Inception(128, (128,192), (32, 96), 64) # Shape(B, 128 + 192 + 96 + 64 = 480, H, W)
        )

        self.inception_4 = nn.Sequential( # inception_4 includes five Inception modules (4a to 4e).
            Inception(192, (96, 208), (16, 48), 64), # Shape(B, 192 + 208 + 48 + 64 = 512, H, W)
            Inception(160, (112, 224), (24, 64), 64), # Shape(B, 160 + 224 + 64 + 64 = 512, H, W)
            Inception(128, (128, 256), (24, 64), 64), # Shape(B, 128 + 256 + 64 + 64 = 512, H, W)
            Inception(112, (144, 288), (32, 64), 64), # Shape(B, 112 + 288 + 32 + 64 = 496, H, W)
            Inception(256, (160, 320), (32, 128), 128) # Shape(B, 256 + 320 + 128 + 128 = 832, H, W)
        )

        self.inception_5 = nn.Sequential( # inception_5 includes two Inception modules (5a and 5b).
            Inception(256, (160, 320), (32, 128), 128), # Shape(B, 256 + 320 + 128 + 128 = 832, H, W)
            Inception(384, (192, 384), (48, 128), 128) # Shape(B, 384 + 384 + 128 + 128 = 1024, H, W)
        )
